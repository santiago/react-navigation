...
export default class DrawerView extends React.PureComponent {
  ...
  _renderNavigationView = () => {
    const details = this.props.sceneDescriptors.find(
    ...
    const tabSceneDescriptors = routes.map(route => {
      const getComponent = () =>
    ...
    return (
      <DrawerSidebar
        ...
        sceneDescriptors={tabSceneDescriptors}
  ...
  render() {
    const descriptor = this.props.sceneDescriptors.find(
      d => d.state.routeName === this.props.navigationConfig.drawerCloseRoute
    );
